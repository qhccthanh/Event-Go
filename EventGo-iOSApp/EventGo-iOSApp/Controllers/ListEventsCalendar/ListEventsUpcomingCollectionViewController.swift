//
//  ListEventsUpcomingCollectionViewController.swift
//  EventGo
//
...
class ListEventsUpcomingCollectionViewController: UICollectionViewController {
...
//        self.collectionView!.register(ListEventsCollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as? ListEventsCollectionViewCell {
            let model = CartoonModel(nameEvent: "Circle K", nameImageEvent: "pokemon_ic", numberStepEvent: 3)
...
extension ListEventsUpcomingCollectionViewController: UICollectionViewDelegateFlowLayout {
