...
open class Popover: UIView {
  ...
  open var cornerRadiusT: CGFloat = 6.0
  ...
  open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
    ...
    self.contentView.layer.cornerRadius = self.cornerRadiusT
  ...
  override open func draw(_ rect: CGRect) {
    ...
    case .up:
      ...
      arrow.addLine(to: CGPoint(x: self.cornerRadiusT, y: self.bounds.height - self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiusT,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
        startAngle: self.radians(90),
        endAngle: self.radians(180),
        clockwise: true)

      arrow.addLine(to: CGPoint(x: 0, y: self.cornerRadiusT))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiusT,
          y: self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusT, y: 0))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusT,
          y: self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.cornerRadiusT))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusT,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiusT
    ...
    case .down:
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusT, y: self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusT,
          y: self.arrowSize.height + self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.cornerRadiusT))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusT,
          y: self.bounds.height - self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
        startAngle: self.radians(0),
        endAngle: self.radians(90),
      ...
      arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.cornerRadiusT))
      arrow.addArc(
        withCenter: CGPoint(x: self.cornerRadiusT,
          y: self.arrowSize.height + self.cornerRadiusT
        ),
        radius: self.cornerRadiusT,
        startAngle: self.radians(180),
