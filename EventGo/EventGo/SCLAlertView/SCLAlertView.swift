...
open class SCLAlertView: UIViewController {
    ...
    fileprivate func setup() {
        // Set up main view
        let leftColor = UIColor(red: 180/255, green: 255/255, blue: 180/255, alpha: 0.7)
        let rightColor = UIColor(red: 46/255, green: 247/255, blue: 191/255, alpha: 0.8)
        
//        view.layer.backgroundColor = UIColor(gradientStyle: .leftToRight, withFrame: self.view.bounds, andColors: [ leftColor, rightColor])
        ...
        contentView.layer.backgroundColor = UIColor(patternImage: UIImage(named: "backgroundColor")!).cgColor
        // Circle View
